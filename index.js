...
function convertArrayToObj(arr) {
  ...
  // ======== Щось не виходить по таким підказкам, якщо можна розясніть що не так і як потрібно =====
